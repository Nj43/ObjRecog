"""
This file generate csv file for Kaggle competition.
"""
...
def main() -> None:
    ...
    model, _, _,test_transform = ModelFactory(args.model_name).get_all()
    ...
    for f in tqdm(os.listdir(test_dir)):
        if "jpeg" in f:
            data = test_transform(pil_loader(test_dir + "/" + f))
